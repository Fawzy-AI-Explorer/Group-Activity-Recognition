...
def load_tracking_annot(path):
    with open(path, 'r') as file:
        ...
        for player_ID, boxes_info in player_boxes.items():  # 12 (Players)
        ...
        return frame_boxes_dct # 9 Frames each one contain 12 Info (Players)
...
# xvfb-run python -m src.DataPreprocessing.volleyball_annot_loader